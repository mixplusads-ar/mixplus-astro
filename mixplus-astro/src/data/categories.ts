...
export const categories: Cat[] = [
  { nameFa:'اجاق گاز', nameEn:'Hobs', slug:'hobs', subs:[
  ...
  { nameFa:'سینک ظرفشویی', nameEn:'Sinks', slug:'sinks', subs:[
  ...
  { nameFa:'فرتوکار', nameEn:'Built-in Ovens', slug:'ovens', subs:[] },
  { nameFa:'هود', nameEn:'Hoods', slug:'hoods', subs:[
